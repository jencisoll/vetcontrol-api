      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center
        ...
        <div className="w-full max-w-md rounded-2xl bg-slate-900
          ...
          <div className="grid grid-cols-2 gap-4 p-6">
            ...
            {field('dni',   'DNI',       '12345678')}
            {field('phone', 'Teléfono',  '999999999')}
            <div className="col-span-2">
              {field('email', 'Email', 'juan@email.com', 'email')}
            </div>
            <div className="col-span-2">
              {field('address', 'Dirección', 'Av. Lima 123')}
            </div>
          </div>
        ...
        <div className="rounded-xl bg-slate-900 border border-slate-800 overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tr className="border-b border-slate-800">
              {['ID', 'Nombre', 'DNI', 'Email', 'Teléfono', 'Mascotas', 'Acciones'].map(h => (
                  <th key={h}
